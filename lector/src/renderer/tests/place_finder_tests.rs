#[cfg(test)]
mod tests {
    use crate::renderer::{html_healer, place_finder::find_plain_text_start};
    ...
    #[test]
    fn matches_across_tags() {
        let html =
            "<p>this is a</p><p>test</p><p>goodbye</p>";

        let result =
            find_plain_text_start(html, "this is atest");
    ...
    #[test]
    fn matches_across_tags_deeper() {
        let html =
            "<p>this is a</p><p><em>test</em></p><p>goodbye</p>";
