...
#[component]
fn Buttons(book_id: String, draft: Signal<Option<BookInfo>>) -> Element {
    rsx! {
        DeleteButton  {book_id: book_id.clone()}
        CancelButton {book_id: book_id.clone()}
        SaveButton {book_id: book_id.clone(), draft}
...
#[component]
fn DeleteButton(book_id: String) -> Element {
    rsx! {
        button {
            style: "
                padding: 10px 24px;
...
#[component]
fn CancelButton(book_id: String) -> Element {
    rsx! {
        button {
            style: "
                padding: 10px 24px;
...
#[component]
fn SaveButton(book_id: String, draft: Signal<Option<BookInfo>>) -> Element {
    rsx! {
        button {
            style: "
                padding: 10px 24px;
